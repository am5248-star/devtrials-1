  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground overflow-hidden relative">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 anime-auth-bg opacity-0">
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-primary/5 rounded-full blur-[120px] animate-glow-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-secondary/5 rounded-full blur-[100px] animate-glow-pulse" style={{ animationDelay: '1.5s' }} />
      </div>
      ...
      <main className="flex-1 flex items-center justify-center p-6 relative z-10">
        <div className="w-full max-w-[440px] anime-auth-card opacity-0">
          <div className="mb-10 flex flex-col items-center text-center space-y-4">
            ...
            <h1 className="text-4xl font-display font-black tracking-tighter uppercase">Authorized <span className="text-primary italic">Access</span></h1>
